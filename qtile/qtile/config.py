...
colors = ['#282828',    # bg (The same as bg0)
          '#cc241d',    # RedD
          '#fb4934',    # RedL
          '#98971a',    # GreenD
          '#b8bb26',    # GreenL
